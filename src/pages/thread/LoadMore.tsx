...
import { connect, maxCommentsDefault, WithGlobalProps } from '../../state';

let loadingStarted = false, showLoadedCount = false, lastTotal: number, lastContext: any, newComments: number;

interface LoadMoreProps extends WithGlobalProps {
...
const loadMoreComments = (props: LoadMoreProps, maxComments: number): void => {
  loadingStarted = true;
