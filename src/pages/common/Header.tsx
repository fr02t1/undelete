...
import { connect, theme, GlobalState } from '../../state';
  ...
  <header>
    <div id='header'>
      ...
      <nav>
        <span className='switch-toggle switch-candy-blue nowrap'>
          ...
          />
          <label htmlFor={theme.dark} title='Dark mode'>
            &#x1F31C;&#xFE0E;
          </label>
          <input
            type='radio'
            ...
            onChange={(e) => props.global.setTheme(e.target.value)}
          />
          <label htmlFor={theme.light} title='Light mode'>
            &#x2600;&#xFE0E;
          </label>
          <input
            type='radio'
            ...
            onChange={(e) => props.global.setTheme(e.target.value)}
          />
          <label htmlFor={theme.system} title='Same mode as system'>
            &#x1F4BB;&#xFE0E;
          </label>
          <a />
        </span>
        <Link className='nowrap' to='/about'>
          about & FAQ
        </Link>
      </nav>
    </div>
    <div id='status'>
      ...
      {props.global.state.statusHelpUrl && (
        <Link id='status-helpurl' to={props.global.state.statusHelpUrl}>
          Need help?
        </Link>
      )}
